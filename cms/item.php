...
<body class="cms">
  <!--header-->
  <header class="header">
    <p class="site-title"><a href="../index.php">Gallery of Air</a></p>
  </header>
  <!-- end header-->
  ...
  <div class="outer">
    ...
    <div class="wrapper wrapper-cms">
      ...
      <div class="search-form">
        <input type="text" name="item_name" placeholder="アイテムを探す" class="search-box">
        <input type="submit" value="検索" class="search-submit">
      </div>
        <!--商品情報-->
        <p class="cms-thumb"><img src="https://placehold.jp/c9c9c9/ffffff/600×600.png?text=%E3%83%80%E3%83%9F%E3%83%BC%E7%94%BB%E5%83%8F" width="250"></p>
        <dl class="cms-list">
          <dt>画像</dt>
          <dd><input type="file" name="fname" class="cms-item" accept="image/*"></dd>
          <dt>カテゴリー</dt>
          <dd><input type="text" name="category" placeholder="カテゴリー名を入力" class="cms-item"></dd>
          <dt>作品名</dt>
          <dd><input type="text" name="item" placeholder="作品名を入力" class="cms-item"></dd>
          <dt>金額</dt>
          <dd><input type="text" name="value" placeholder="金額を入力" class="cms-item"></dd>
          <dt>作品紹介文</dt>
          <dd><textarea name="description" id="" cols="30" rows="10" class="cms-item">作品紹介文を入力</textarea></dd>
        </dl>
        <!--end 商品情報-->
